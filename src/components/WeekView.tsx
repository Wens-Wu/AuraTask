      ...
      <div className={`week-grid ${dragging ? "is-dragging" : ""}`}>
        {days.map((d) => {
          ...
          return (
            ...
            >
              <div
                className={`week-col-head ${isAllTarget ? "is-drop-target" : ""}`}
                data-day={key}
                data-slot="all"
              >
              ...
              <div
                className={`slot-band slot-all ${isAllTarget ? "is-drop-target" : ""}`}
                data-day={key}
                data-slot="all"
              >
                {bucket.all.map((t) => (
